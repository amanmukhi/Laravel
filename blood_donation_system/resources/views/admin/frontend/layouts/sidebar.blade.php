            ...
            <div class="scroll-sidebar" data-sidebarbg="skin6">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="http://adminmart.com/docs/docs.html" aria-expanded="false"><i data-feather="edit-3" class="feather-icon"></i><span class="hide-menu">Documentation</span></a></li>
                        ...
                        <li class="nav-small-cap"><span class="hide-menu">All Records</span></li>

                        <li class="sidebar-item"> <a class="sidebar-link" href="{{ route('donor_index') }}" aria-expanded="false"><i data-feather="users" class="feather-icon"></i><span class="hide-menu">donor</span></a>
                        <li class="sidebar-item"> <a class="sidebar-link" href="{{ route('user_index') }}" aria-expanded="false"><i data-feather="users" class="feather-icon"></i><span class="hide-menu">User</span></a>
                        </li>
